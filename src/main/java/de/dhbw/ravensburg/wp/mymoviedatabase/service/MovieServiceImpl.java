...
public class MovieServiceImpl implements MovieService{
    ...
    public void changeMovieTitle(long id, String newMovieName){
        ...
        //Durch @Transactional wird automatisch gespeichert, sodass die
        // Validitätsabfrage hier unnötig ist, da unabhängig hiervon gespeichert wird.
        // Das heißt es sollte entweder @Transactional entfernt werden und der bestehende Block bleibt
        // oder die setTitle Methode wird statt der save Methode in die Then-Condition verwendet.
