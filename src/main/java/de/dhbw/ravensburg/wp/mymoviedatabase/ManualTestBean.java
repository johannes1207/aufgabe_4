...
public class ManualTestBean {
    ...
    ManualTestBean(MovieRepository movieRepository, MovieService movieService, AwardService awardService)
    {
    ...
    public void callController(){
        ...
        //Award anlegen
        Award oskar_1 = new Award("Oskar", "Best Picture", 2008);
        //Wenn über Movie persistiert wird müssen die Referenzen beidseitig gesetzt werden
        // movie_1.setAwards(Arrays.asList(oskar_1));
        // oskar_1.setMovie(movie_1);
        // Wenn über das AwardRepository persistiert wird muss nur die Awardseite gesetzt sein
        oskar_1.setMovie(movie_1);
        ...
        this.awardService.addAward(oskar_1);
